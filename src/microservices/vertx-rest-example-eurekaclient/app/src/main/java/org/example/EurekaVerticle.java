...
public class EurekaVerticle extends AbstractVerticle {
    ...
    public EurekaVerticle(String applicationName, int port) {
        this(applicationName, "localhost:" + applicationName + ":" + port, port);
    }
    ...
    private void registerWithEureka() {
        JsonObject instance = new JsonObject()
                .put("instance", new JsonObject()
                        .put("hostName", "vertx-rest-eurekaclient")
                        ...
                        .put("status", "UP")
                        .put("healthCheckUrl", "http://vertx-rest-eurekaclient:" + port + "/health")
                        .put("statusPageUrl", "http://vertx-rest-eurekaclient:" + port + "/info")
                        .put("homePageUrl", "http://vertx-rest-eurekaclient:" + port + "/")
