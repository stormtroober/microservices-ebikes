...
public class ServiceVerticle extends AbstractVerticle {
    ...
    public ServiceVerticle(String applicationName, int port) {
    ...
    private void registerWithEureka() {
        JsonObject instance = new JsonObject()
                .put("instance", new JsonObject()
                        .put("hostName", "ebike-service-eurekaclient")
                        ...
                        .put("status", "UP")
                        .put("healthCheckUrl", "http://ebike-service-eurekaclient:" + port + "/health")
                        .put("statusPageUrl", "http://ebike-service-eurekaclient:" + port + "/info")
                        .put("homePageUrl", "http://ebike-service-eurekaclient:" + port + "/")
        ...
        client
            ...
            .send(ar -> {
                if (ar.succeeded()) {
                    ...
                    System.err.println(
                        "Failed to send heartbeat: " + ar.cause()
                    );
                }
            });
    }
