...
| E-Bike System
| Ambiente di produzione
| Il sistema gestisce l'aumento di carico
| Nessuna degradazione delle prestazioni

| Dependability
| System
| Esecuzione di operazioni critiche
| E-Bike System
| Ambiente di produzione
| Il sistema esegue le operazioni senza errori
| Percentuale di successo delle operazioni critiche
...
| Il sistema viene modificato facilmente
